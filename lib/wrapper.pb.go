...
var file_wrapper_proto_rawDesc = []byte{
	...
	0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x22, 0x25, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67,
	...
	0x0d, 0x55, 0x49, 0x6e, 0x74, 0x36, 0x34, 0x57, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x12, 0x14,
	0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
func file_wrapper_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_wrapper_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*UInt64Wrapper); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
