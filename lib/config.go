...
type RPCConfig struct {
	...
	// IndexerBlobsTimeoutS extends the write deadline for indexer-blobs alone (via
	// http.ResponseController) - left at TimeoutS, every other endpoint would inherit it too.
