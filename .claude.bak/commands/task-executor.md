...
3. **Task Identification**: Scan through the TODO.md file to find the next incomplete task. Look for:
   - Unchecked checkboxes (- [ ]) MUST ALWAYS be executed, regardless of any existing results
   - When previous results exist in RESULTS.md, UPDATE and EXPAND the findings, don't skip
