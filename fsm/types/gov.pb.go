...
type ValidatorParams struct {
	...
	LockDeadlineBlocks uint64 `protobuf:"varint,15,opt,name=lock_deadline_blocks,json=lockDeadlineBlocks,proto3" json:"lockDeadlineBlocks"` // @gotags: json:"lockDeadlineBlocks"
