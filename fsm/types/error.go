...
func ErrInvalidLockerDeadline() lib.ErrorI {
	return lib.NewError(lib.CodeInvalidLockerDeadline, lib.StateMachineModule, "lock order deadline height is invalid")
}
