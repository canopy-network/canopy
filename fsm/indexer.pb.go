...
type IndexerBlob struct {
	...
	NonSignersDelta bool `protobuf:"varint,24,opt,name=non_signers_delta,json=nonSignersDelta,proto3" json:"non_signers_delta,omitempty"`
...
func (x *IndexerBlob) GetNonSignersDelta() bool {
	if x != nil {
		return x.NonSignersDelta
	}
	return false
}
...
const file_indexer_proto_rawDesc = "" +
	"\n" +
	"\rindexer.proto\x12\x05types\"\xd5\a\n" +
	...
	"\x11block_non_signers\x18\x17 \x03(\fR\x0fblockNonSigners\x12*\n" +
	"\x11non_signers_delta\x18\x18 \x01(\bR\x0fnonSignersDelta\"l\n" +
	"\fIndexerBlobs\x12,\n" +
