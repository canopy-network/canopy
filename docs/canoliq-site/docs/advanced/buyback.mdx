...
**In one sentence:** governance can spend treasury CNPY to buy CPLQ and then either burn it
(shrinking supply) or hand it to lock-boosted stakers — a DAO-controlled value-capture lever.
