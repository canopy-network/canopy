...
**In one sentence:** the DAO can pay out treasury funds, but anything above a threshold must
wait out a timelock and collect multiple signatures before it moves.
