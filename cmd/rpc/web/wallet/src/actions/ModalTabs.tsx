                ...
                >
                    {tabs.map((tab, index) => (
                        <TabsTrigger
                            ...
                            value={tab.value}
                            variant="wallet"
                            className="gap-1.5 sm:gap-2 md:gap-3 text-xs sm:text-sm md:text-base lg:text-lg text-white/60 hover:text-white/90 data-[state=active]:border-white data-[state=active]:text-white"
                        >
