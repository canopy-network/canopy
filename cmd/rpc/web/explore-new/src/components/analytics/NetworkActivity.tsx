...
const NetworkActivity: React.FC<NetworkActivityProps> = ({ timeFilter, loading, transactionsData }) => {
    // Usar datos reales de transacciones cuando estén disponibles
    const getTransactionData = () => {
        if (!transactionsData?.results || !Array.isArray(transactionsData.results)) {
            return [] // Devolver un array vacío si no hay datos reales o no son válidos
        }
    ...
    // ELIMINADO: Ya no se utiliza ninguna bandera de simulación
