                ...
                >
                    ...
                    <div className="bg-bg-secondary rounded-xl p-6 border border-bg-accent relative overflow-hidden">
                        <div className="flex items-center justify-between">
                            <h3 className="text-text-muted text-sm font-medium mb-2">Total Balance</h3>
                    ...
                    <div className="bg-bg-secondary rounded-xl p-6 border border-bg-accent relative overflow-hidden">
                        <div className="flex items-center justify-between">
                            <h3 className="text-text-muted text-sm font-medium mb-2">Total Staked</h3>
                    ...
                    <div className="bg-bg-secondary rounded-xl p-6 border border-bg-accent relative overflow-hidden flex flex-col justify-between">
                        <div className="flex items-center justify-between">
                            <h3 className="text-text-muted text-sm font-medium mb-2">Active Addresses</h3>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-400 text-sm font-medium">All Validators Synced</span>
                        </div>
                    </div>
                </motion.div>
