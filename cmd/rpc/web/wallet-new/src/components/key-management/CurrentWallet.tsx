...
export const CurrentWallet = (): JSX.Element => {
  ...
  const handleRevealPrivateKeys = () => {
    if (
      confirm(
        "Are you sure you want to reveal your private keys? This is a security risk.",
      )
    ) {
      setShowPrivateKey(!showPrivateKey);
      toast.success({
        title: showPrivateKey ? "Private Keys Hidden" : "Private Keys Revealed",
        description: showPrivateKey
          ? "Your keys are now hidden"
          : "Be careful! Your private keys are visible",
        icon: showPrivateKey ? (
