                ...
                processedValidators.map((node, index) => {
                  return (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col">
                            <span className="text-text-primary text-sm font-medium">
                              {node.originalValidator.nickname ||
                                `Node ${index + 1}`}
                            </span>
                      ...
                      <td className="py-4">
                        <span
                          className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(node.status)}`}
                        >
                          {node.status}
                        </span>
                      </td>
                      ...
                      <td className="py-4">
                        ...
                        >
                          {node.status === "Staked" ? (
                            <Pause className="text-gray-400 w-4 h-4" />
                          ) : (
          ...
          {processedValidators.map((node, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 rounded-full ${getNodeColor(index)}`}
                  ></div>
                  <div>
                ...
                >
                  {node.status === "Staked" ? (
                    <Pause className="text-gray-400 w-5 h-5" />
                  ) : (
                    <Play className="text-gray-400 w-5 h-5" />
                  )}
                </button>
              </div>
