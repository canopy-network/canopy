...
export const StakedBalanceCard = () => {
    ...
    const { data: chartData = [], isLoading: chartLoading } = useBalanceChart({ points: 4, type: 'staked' });
                            ...
                            >
                                ...
                                <AnimatePresence>
                                    {hoveredPoint !== null && mousePosition && chartData[hoveredPoint] && (
                                        ...
                                        >
                                            <div className="text-xs text-text-muted mb-1">{chartData[hoveredPoint].label}</div>
