...
export const StatsCards: React.FC<StatsCardsProps> = ({
    ...
    const statsData = [
        {
            id: 'totalBalance',
            title: getText('ui.allAddresses.totalBalance', 'Total Balance'),
            value: totalBalance,
        ...
        {
            id: 'totalStaked',
            title: getText('ui.allAddresses.totalStaked', 'Total Staked'),
            value: totalStaked,
        ...
        {
            id: 'totalRewards',
            title: getText('ui.allAddresses.totalRewards', 'Total Rewards'),
            value: totalRewards,
