...
export const StatsCards: React.FC<StatsCardsProps> = ({
    ...
    const statsData = [
        {
            id: 'totalStaked',
            title: getText('ui.staking.totalStaked', 'Total Staked'),
            value: `${formatStakedAmount(totalStaked)} CNPY`,
            subtitle: `${getText('ui.staking.acrossValidators', 'Across')} ${validatorsCount} ${getText('ui.staking.validators', 'validators')}`,
        ...
        {
            id: 'rewardsEarned',
            title: getText('ui.staking.rewardsEarned', 'Rewards Earned'),
            value: `${formatRewards(totalRewards)} CNPY`,
            subtitle: getText('ui.staking.last24h', 'Last 24 hours'),
        ...
        {
            id: 'activeValidators',
            title: getText('ui.staking.activeValidators', 'Active Validators'),
        ...
        {
            id: 'chainsStaked',
            title: getText('ui.staking.chainsStaked', 'Chains Staked'),
