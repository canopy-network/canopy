...
// proto change).
type MessageCanoliqTransfer struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MessageCanoliqTransfer) Reset() {
	*x = MessageCanoliqTransfer{}
	mi := &file_canoliq_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MessageCanoliqTransfer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageCanoliqTransfer) ProtoMessage() {}

func (x *MessageCanoliqTransfer) ProtoReflect() protoreflect.Message {
	mi := &file_canoliq_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageCanoliqTransfer.ProtoReflect.Descriptor instead.
func (*MessageCanoliqTransfer) Descriptor() ([]byte, []int) {
	return file_canoliq_proto_rawDescGZIP(), []int{5}
}

func (x *MessageCanoliqTransfer) GetFromAddress() []byte {
	if x != nil {
		return x.FromAddress
	}
	return nil
...
func (x *MessageCanoliqTransfer) GetToAddress() []byte {
	if x != nil {
		return x.ToAddress
	}
	return nil
...
func (x *MessageCanoliqTransfer) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
type CanoliqGlobals struct {
	...
	LastAttributedReward uint64 `protobuf:"varint,23,opt,name=last_attributed_reward,json=lastAttributedReward,proto3" json:"lastAttributedReward"` // @gotags: json:"lastAttributedReward"
	...
	CarriedReward uint64 `protobuf:"varint,24,opt,name=carried_reward,json=carriedReward,proto3" json:"carriedReward"` // @gotags: json:"carriedReward"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CanoliqGlobals) GetLastAttributedReward() uint64 {
	if x != nil {
		return x.LastAttributedReward
	}
	return 0
}

func (x *CanoliqGlobals) GetCarriedReward() uint64 {
	if x != nil {
		return x.CarriedReward
	}
	return 0
}
...
type CanoliqParams struct {
	...
	CanoliqTransferFee uint64 `protobuf:"varint,38,opt,name=canoliq_transfer_fee,json=canoliqTransferFee,proto3" json:"canoliqTransferFee"` // @gotags: json:"canoliqTransferFee"
	...
	// not own.
	StakeOutputAddresses [][]byte `protobuf:"bytes,39,rep,name=stake_output_addresses,json=stakeOutputAddresses,proto3" json:"stakeOutputAddresses"` // @gotags: json:"stakeOutputAddresses"
	...
	MaxRewardBpsPerBlock uint64 `protobuf:"varint,40,opt,name=max_reward_bps_per_block,json=maxRewardBpsPerBlock,proto3" json:"maxRewardBpsPerBlock"` // @gotags: json:"maxRewardBpsPerBlock"
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *CanoliqParams) GetCanoliqTransferFee() uint64 {
	if x != nil {
		return x.CanoliqTransferFee
	}
	return 0
}
...
func (x *CanoliqParams) GetTvlCapBps() uint64 {
	if x != nil {
		return x.TvlCapBps
	}
	return 0
...
func (x *CanoliqParams) GetStakeOutputAddresses() [][]byte {
	if x != nil {
		return x.StakeOutputAddresses
	}
	return nil
}

func (x *CanoliqParams) GetMaxRewardBpsPerBlock() uint64 {
	if x != nil {
		return x.MaxRewardBpsPerBlock
	}
	return 0
}
...
type ValidatorRegistryEntry struct {
	...
	Owned         bool `protobuf:"varint,3,opt,name=owned,proto3" json:"owned"` // @gotags: json:"owned"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ValidatorRegistryEntry) GetOwned() bool {
	if x != nil {
		return x.Owned
	}
	return false
...
func (x *ProposalOTCProgramFund) Reset() {
	*x = ProposalOTCProgramFund{}
	mi := &file_canoliq_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProposalOTCProgramFund) Descriptor() ([]byte, []int) {
	return file_canoliq_proto_rawDescGZIP(), []int{46}
}
...
const file_canoliq_proto_rawDesc = "" +
	...
	"\ffrom_address\x18\x01 \x01(\fR\vfromAddress\"r\n" +
	"\x16MessageCanoliqTransfer\x12!\n" +
	"\ffrom_address\x18\x01 \x01(\fR\vfromAddress\x12\x1d\n" +
	"\n" +
	"to_address\x18\x02 \x01(\fR\ttoAddress\x12\x16\n" +
	"\x06amount\x18\x03 \x01(\x04R\x06amount\"\xed\b\n" +
	...
	"\x10next_otc_lock_id\x18\x16 \x01(\x04R\rnextOtcLockId\x124\n" +
	"\x16last_attributed_reward\x18\x17 \x01(\x04R\x14lastAttributedReward\x12%\n" +
	"\x0ecarried_reward\x18\x18 \x01(\x04R\rcarriedReward\"\x8d\x01\n" +
	"\n" +
	"Redemption\x12\x0e\n" +
	...
	"\x0eclaimed_amount\x18\a \x01(\x04R\rclaimedAmount\"\xfc\r\n" +
	...
	"\x11cplq_transfer_fee\x18\t \x01(\x04R\x0fcplqTransferFee\x120\n" +
	"\x14canoliq_transfer_fee\x18& \x01(\x04R\x12canoliqTransferFee\x12#\n" +
	"\rinsurance_bps\x18\n" +
	...
	"governance\x12\x1e\n" +
	"\vtvl_cap_bps\x18\x19 \x01(\x04R\ttvlCapBps\x120\n" +
	...
	"\x12otc_tier120_blocks\x18% \x01(\x04R\x10otcTier120Blocks\x124\n" +
	"\x16stake_output_addresses\x18' \x03(\fR\x14stakeOutputAddresses\x126\n" +
	"\x18max_reward_bps_per_block\x18( \x01(\x04R\x14maxRewardBpsPerBlock\"\xb5\x01\n" +
	...
	"\x05stake\x18\x02 \x01(\x04R\x05stake\x12\x14\n" +
	"\x05owned\x18\x03 \x01(\bR\x05owned\"L\n" +
...
var file_canoliq_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_canoliq_proto_goTypes = []any{
	...
	(*MessageCanoliqTransfer)(nil),        // 12: types.MessageCanoliqTransfer
	(*CanoliqGlobals)(nil),                // 13: types.CanoliqGlobals
	(*Redemption)(nil),                    // 14: types.Redemption
	(*RedemptionIndex)(nil),               // 15: types.RedemptionIndex
	(*VestingSchedule)(nil),               // 16: types.VestingSchedule
	(*CanoliqParams)(nil),                 // 17: types.CanoliqParams
	(*RestakingPolicyEntry)(nil),          // 18: types.RestakingPolicyEntry
	(*GovernanceTier)(nil),                // 19: types.GovernanceTier
	(*VestingIndex)(nil),                  // 20: types.VestingIndex
	(*MessageCPLQStake)(nil),              // 21: types.MessageCPLQStake
	(*MessageCPLQUnstake)(nil),            // 22: types.MessageCPLQUnstake
	(*MessageCPLQClaimUnstake)(nil),       // 23: types.MessageCPLQClaimUnstake
	(*MessageCPLQProposalCreate)(nil),     // 24: types.MessageCPLQProposalCreate
	(*MessageCPLQVote)(nil),               // 25: types.MessageCPLQVote
	(*MessageBuybackExecute)(nil),         // 26: types.MessageBuybackExecute
	(*MessageDAOTreasurySpend)(nil),       // 27: types.MessageDAOTreasurySpend
	(*MessageMultisigApprove)(nil),        // 28: types.MessageMultisigApprove
	(*CPLQStake)(nil),                     // 29: types.CPLQStake
	(*UnstakingCPLQ)(nil),                 // 30: types.UnstakingCPLQ
	(*UnstakingIndex)(nil),                // 31: types.UnstakingIndex
	(*Proposal)(nil),                      // 32: types.Proposal
	(*ProposalIndex)(nil),                 // 33: types.ProposalIndex
	(*Vote)(nil),                          // 34: types.Vote
	(*ProposalParamChange)(nil),           // 35: types.ProposalParamChange
	(*ProposalBuyback)(nil),               // 36: types.ProposalBuyback
	(*ProposalTreasurySpend)(nil),         // 37: types.ProposalTreasurySpend
	(*ProposalValidatorEject)(nil),        // 38: types.ProposalValidatorEject
	(*ProposalEmergency)(nil),             // 39: types.ProposalEmergency
	(*ProposalProtocolUpgrade)(nil),       // 40: types.ProposalProtocolUpgrade
	(*BuybackOrder)(nil),                  // 41: types.BuybackOrder
	(*TreasurySpend)(nil),                 // 42: types.TreasurySpend
	(*MultisigApproval)(nil),              // 43: types.MultisigApproval
	(*CPLQStakeIndex)(nil),                // 44: types.CPLQStakeIndex
	(*ValidatorRegistryEntry)(nil),        // 45: types.ValidatorRegistryEntry
	(*ValidatorRegistry)(nil),             // 46: types.ValidatorRegistry
	(*AlertState)(nil),                    // 47: types.AlertState
	(*OTCLock)(nil),                       // 48: types.OTCLock
	(*OTCLockIndex)(nil),                  // 49: types.OTCLockIndex
	(*MessageOTCLockCreate)(nil),          // 50: types.MessageOTCLockCreate
	(*MessageOTCLockClaim)(nil),           // 51: types.MessageOTCLockClaim
	(*MessageOTCLockCancel)(nil),          // 52: types.MessageOTCLockCancel
	(*ProposalOTCProgramFund)(nil),        // 53: types.ProposalOTCProgramFund
	(*anypb.Any)(nil),                     // 54: google.protobuf.Any
}
var file_canoliq_proto_depIdxs = []int32{
	19, // 0: types.CanoliqParams.governance:type_name -> types.GovernanceTier
	18, // 1: types.CanoliqParams.restaking_policy:type_name -> types.RestakingPolicyEntry
	0,  // 2: types.GovernanceTier.action:type_name -> types.ActionType
	1,  // 3: types.MessageCPLQStake.lock_tier:type_name -> types.LockTier
	54, // 4: types.MessageCPLQProposalCreate.payload:type_name -> google.protobuf.Any
	2,  // 5: types.MessageCPLQVote.choice:type_name -> types.VoteChoice
	1,  // 6: types.CPLQStake.lock_tier:type_name -> types.LockTier
	54, // 7: types.Proposal.payload:type_name -> google.protobuf.Any
	3,  // 8: types.Proposal.status:type_name -> types.ProposalStatus
	0,  // 9: types.Proposal.action_type:type_name -> types.ActionType
	19, // 10: types.Proposal.tier:type_name -> types.GovernanceTier
	2,  // 11: types.Vote.choice:type_name -> types.VoteChoice
	17, // 12: types.ProposalParamChange.params:type_name -> types.CanoliqParams
	...
	35, // 15: types.ProposalEmergency.param_change:type_name -> types.ProposalParamChange
	4,  // 16: types.BuybackOrder.mode:type_name -> types.BuybackMode
	36, // 17: types.BuybackOrder.payload:type_name -> types.ProposalBuyback
	37, // 18: types.TreasurySpend.payload:type_name -> types.ProposalTreasurySpend
	45, // 19: types.ValidatorRegistry.entries:type_name -> types.ValidatorRegistryEntry
