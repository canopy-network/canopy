...
type Event struct {
	...
	EventType string `protobuf:"bytes,1,opt,name=event_type,json=eventType,proto3" json:"event_type,omitempty"` // @gotags: json:"eventType"
	...
	BlockHeight uint64 `protobuf:"varint,94,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"` // @gotags: json:"blockHeight"
	...
	BlockHash []byte `protobuf:"bytes,95,opt,name=block_hash,json=blockHash,proto3" json:"block_hash,omitempty"` // @gotags: json:"blockHash"
...
const file_event_proto_rawDesc = "" +
	...
	"\x03msg\"5\n" +
	"\vEventCustom\x12&\n" +
	"\x03msg\x18\x01 \x01(\v2\x14.google.protobuf.AnyR\x03msgB5Z3github.com/canopy-network/canopy/plugin/go/contractb\x06proto3"
